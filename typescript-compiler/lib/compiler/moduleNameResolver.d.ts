import { CommandLineOption, CompilerHost, CompilerOptions, DiagnosticMessage, DiagnosticReporter, GetEffectiveTypeRootsHost, MapLike, ModuleResolutionHost, ModuleResolutionKind, Path, ResolutionMode, ResolvedModuleWithFailedLookupLocations, ResolvedProjectReference, ResolvedTypeReferenceDirectiveWithFailedLookupLocations } from "./_namespaces/ts";
/** @internal */
...
/** @internal */
export declare function createCacheWithRedirects<K, V>(ownOptions: CompilerOptions | undefined, optionsToRedirectsKey: Map<CompilerOptions, RedirectsCacheKey>): CacheWithRedirects<K, V>;
/** @internal */

import { CommentDirective, CommentKind, CommentRange, DiagnosticMessage, JSDocParsingMode, JSDocSyntaxKind, JsxTokenSyntaxKind, KeywordSyntaxKind, LanguageVariant, LineAndCharacter, MapLike, PunctuationOrKeywordSyntaxKind, ScriptKind, ScriptTarget, SourceFileLike, SyntaxKind, TokenFlags } from "./_namespaces/ts";

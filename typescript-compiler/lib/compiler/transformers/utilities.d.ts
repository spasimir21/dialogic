...
export interface ExternalModuleInfo {
    ...
    exportedFunctions: FunctionDeclaration[] | undefined;
...
/** @internal */
export declare class IdentifierNameMultiMap<V> extends IdentifierNameMap<V[]> {
    add(key: Identifier, value: V): V[];
    remove(key: Identifier, value: V): void;
}
/**
...
/** @internal */
export declare function isSimpleParameter(node: ParameterDeclaration): boolean;
/** @internal */

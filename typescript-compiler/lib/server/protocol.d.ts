...
import type { ApplicableRefactorInfo, CompilerOptionsValue, CompletionsTriggerCharacter, EndOfLineState, FileExtensionInfo, HighlightSpanKind, InteractiveRefactorArguments, OutputFile, RefactorTriggerReason, RenameInfoFailure, RenameLocation, ScriptElementKind, ScriptKind, SignatureHelpTriggerReason, SymbolDisplayPart, TextChange, TextInsertion, TodoComment, TodoCommentDescriptor, TypeAcquisition, UserPreferences } from "./_namespaces/ts";
import { ClassificationType, CompletionTriggerKind, OrganizeImportsMode, SemicolonPreference } from "./_namespaces/ts";

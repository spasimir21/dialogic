import { ArrowFunction, Block, CallExpression, ClassLikeDeclaration, CodeFixContextBase, Expression, FunctionDeclaration, FunctionExpression, GetAccessorDeclaration, Identifier, LanguageServiceHost, MethodDeclaration, MethodSignature, Modifier, ModifierFlags, Node, NodeArray, NodeBuilderFlags, ObjectLiteralExpression, PrivateIdentifier, Program, PropertyAssignment, PropertyDeclaration, PropertyName, QuotePreference, ScriptTarget, SetAccessorDeclaration, Signature, SourceFile, Symbol, SymbolTracker, SyntaxKind, textChanges, TextSpan, TsConfigSourceFile, Type, TypeChecker, TypeNode, UserPreferences } from "../_namespaces/ts";

...
/** @internal */
export declare const computedOptions: {
    target: {
        dependencies: "module"[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module">) => ScriptTarget;
    };
    allowJs: {
    ...
    allowSyntheticDefaultImports: {
        dependencies: ("target" | "module" | "moduleResolution")[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "allowSyntheticDefaultImports" | "module" | "moduleResolution">) => boolean;
    };
    alwaysStrict: {
        dependencies: "strict"[];
    ...
    module: {
        dependencies: "target"[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module">) => ModuleKind;
    };
    moduleResolution: {
        dependencies: ("target" | "module")[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "moduleResolution">) => ModuleResolutionKind;
    };
    moduleDetection: {
        dependencies: ("target" | "module")[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "moduleDetection">) => ModuleDetectionKind;
    };
    noImplicitAny: {
        dependencies: "strict"[];
    ...
    resolveJsonModule: {
        dependencies: ("target" | "module" | "moduleResolution")[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "moduleResolution" | "resolveJsonModule">) => boolean;
    };
    esModuleInterop: {
        dependencies: ("target" | "module")[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "esModuleInterop">) => boolean;
    };
    useDefineForClassFields: {
        dependencies: ("target" | "module")[];
        computeValue: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "useDefineForClassFields">) => boolean;
    };
};
/** @internal */
export declare const getEmitScriptTarget: (compilerOptions: Pick<CompilerOptions, "target" | "module">) => ScriptTarget;
/** @internal */
export declare const getEmitModuleKind: (compilerOptions: Pick<CompilerOptions, "target" | "module">) => ModuleKind;
/** @internal */
export declare const getEmitModuleResolutionKind: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "moduleResolution">) => ModuleResolutionKind;
/** @internal */
export declare const getEmitModuleDetectionKind: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "moduleDetection">) => ModuleDetectionKind;
/** @internal */
export declare const getIsolatedModules: (compilerOptions: Pick<CompilerOptions, "isolatedModules" | "verbatimModuleSyntax">) => boolean;
/** @internal */
export declare const getESModuleInterop: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "esModuleInterop">) => boolean;
/** @internal */
export declare const getAllowSyntheticDefaultImports: (compilerOptions: Pick<CompilerOptions, "target" | "allowSyntheticDefaultImports" | "module" | "moduleResolution">) => boolean;
/** @internal */
export declare const getResolvePackageJsonExports: (compilerOptions: Pick<CompilerOptions, "moduleResolution" | "resolvePackageJsonExports">) => boolean;
/** @internal */
export declare const getResolvePackageJsonImports: (compilerOptions: Pick<CompilerOptions, "moduleResolution" | "resolvePackageJsonExports" | "resolvePackageJsonImports">) => boolean;
/** @internal */
export declare const getResolveJsonModule: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "moduleResolution" | "resolveJsonModule">) => boolean;
/** @internal */
export declare const getEmitDeclarations: (compilerOptions: Pick<CompilerOptions, "declaration" | "composite">) => boolean;
/** @internal */
export declare const shouldPreserveConstEnums: (compilerOptions: Pick<CompilerOptions, "isolatedModules" | "preserveConstEnums" | "verbatimModuleSyntax">) => boolean;
/** @internal */
export declare const isIncrementalCompilation: (compilerOptions: Pick<CompilerOptions, "composite" | "incremental">) => boolean;
/** @internal */
export declare const getAreDeclarationMapsEnabled: (compilerOptions: Pick<CompilerOptions, "declaration" | "declarationMap" | "composite">) => boolean;
/** @internal */
export declare const getAllowJSCompilerOption: (compilerOptions: Pick<CompilerOptions, "allowJs" | "checkJs">) => boolean;
/** @internal */
export declare const getUseDefineForClassFields: (compilerOptions: Pick<CompilerOptions, "target" | "module" | "useDefineForClassFields">) => boolean;
/** @internal */
...
/** @internal */
export declare function hasResolutionModeOverride(node: ImportTypeNode | ImportDeclaration | ExportDeclaration | undefined): boolean;
/** @internal */
...
/** @internal */
export declare function evaluatorResult<T extends string | number | undefined>(value: T, isSyntacticallyString?: boolean, resolvedOtherFiles?: boolean): EvaluatorResult<T>;
/** @internal */
...
/** @internal */
export declare function createNameResolver({ compilerOptions, requireSymbol, argumentsSymbol, error, getSymbolOfDeclaration, globals, lookup, setRequiresScopeChangeCache, getRequiresScopeChangeCache, onPropertyWithInvalidInitializer, onFailedToResolveSymbol, onSuccessfullyResolvedSymbol, }: {
...
}): (location: Node | undefined, nameArg: __String | Identifier, meaning: SymbolFlags, nameNotFoundMessage: DiagnosticMessage | undefined, isUse: boolean, excludeGlobals?: boolean) => Symbol | undefined;
export {};

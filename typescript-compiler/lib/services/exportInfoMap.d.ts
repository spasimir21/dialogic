import { __String, CancellationToken, CompilerOptions, FutureSourceFile, LanguageServiceHost, ModuleSpecifierCache, ModuleSpecifierResolutionHost, PackageJsonImportFilter, Path, Program, SourceFile, Symbol, SymbolFlags, TypeChecker, UserPreferences } from "./_namespaces/ts";
/** @internal */

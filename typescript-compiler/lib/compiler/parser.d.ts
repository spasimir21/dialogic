import { BaseNodeFactory, Diagnostic, DiagnosticMessage, EntityName, JSDoc, JSDocParsingMode, JSDocTypeExpression, JsonSourceFile, JsxTagNameExpression, Node, NodeArray, NodeFactory, PackageJsonInfo, PragmaContext, ResolutionMode, ScriptKind, ScriptTarget, SourceFile, TextChangeRange } from "./_namespaces/ts";
/**

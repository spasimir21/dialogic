...
/** @internal */
export declare function getUsageInfo(oldFile: SourceFile, toMove: readonly Statement[], checker: TypeChecker, existingTargetLocals?: ReadonlySet<Symbol>): UsageInfo;
/** @internal */

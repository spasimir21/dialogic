import { __String, ArrayLiteralExpression, BindingOrAssignmentElement, Block, Comparison, EmitHelper, EmitHelperUniqueNameCallback, EntityName, Expression, FunctionExpression, Identifier, ParameterDeclaration, PrivateIdentifier, TextRange, TransformationContext, UnscopedEmitHelper } from "../_namespaces/ts";
/** @internal */
 ...
 * @internal
 */
export declare const addDisposableResourceHelper: UnscopedEmitHelper;
/**
 * @internal
 */
export declare const disposeResourcesHelper: UnscopedEmitHelper;
/** @internal */

import { BuilderProgram, BuilderProgramHost, BuilderState, BuildInfo, CompilerHost, CompilerOptions, Diagnostic, DiagnosticCategory, DiagnosticMessageChain, EmitAndSemanticDiagnosticsBuilderProgram, HostForComputeHash, Path, Program, ProjectReference, ReadBuildProgramHost, RepopulateModuleNotFoundDiagnosticChain, SemanticDiagnosticsBuilderProgram, SourceFile, WriteFileCallbackData } from "./_namespaces/ts";
/** @internal */
...
export declare const enum BuilderFileEmit {
    ...
    Dts = 8,// emit d.ts file
    DtsMap = 16,// emit d.ts.map file
    AllJs = 7,
    AllDts = 24,
    All = 31
}
...
/** @internal */
export type SavedBuildProgramEmitState = Pick<BuilderProgramState, "affectedFilesPendingEmit" | "seenEmittedFiles" | "programEmitPending" | "emitSignatures" | "outSignature" | "latestChangedDtsFile" | "hasChangedEmitSignature" | "buildInfoEmitPending" | "emitDiagnosticsPerFile"> & {

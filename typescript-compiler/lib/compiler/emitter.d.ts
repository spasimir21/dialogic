...
import { BuildInfo, Bundle, CompilerOptions, EmitFileNames, EmitHost, EmitOnly, EmitResolver, EmitResult, EmitTransformers, Extension, GetCanonicalFileName, ParsedCommandLine, Printer, PrinterOptions, PrintHandlers, ProgramBuildInfo, SourceFile } from "./_namespaces/ts";
/** @internal */
...
/** @internal */
export declare function createBuildInfo(program: ProgramBuildInfo | undefined): BuildInfo;
/** @internal */
